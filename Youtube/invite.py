...
from Luffy.config import Config
...
async def refer(client,message):
    ...
    await message.reply_photo(photo=random.choice(PICS), caption=START_TEXT.format(user=message.from_user.mention, bot=client.mention),reply_markup=reply_markup,)
